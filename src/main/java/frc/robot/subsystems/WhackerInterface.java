...
public interface WhackerInterface {
    public static class WhackerInterfaceInputs {
    ...
    public default void updateInputs(WhackerInterfaceInputs inputs) {}
    ...
    public default void backAndForth(double position) {}
}